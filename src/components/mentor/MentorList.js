        ...
        <Layout>
          ...
          <Layout style={{height:"550px"}}>
            <Sider width={80} style={{backgroundColor:"#FFFFFF",marginLeft:"0px"}}>
              ...
              <div>
                 <Link to={"./DashBoard"}><button className="bg-white" id="dashboard"><p id="db"><b>DashBoard</b></p></button></Link> 
                <Link to={"./BatchList"}><button className="bg-white" id="batchlist"><p id="batch"><b>Batch</b></p></button></Link>
                </div>
